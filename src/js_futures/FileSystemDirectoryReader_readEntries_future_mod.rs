...
pub struct FileSystemDirectoryReader_readEntries_future {
  inner: Rc<RefCell<Inner>>,
}

impl FileSystemDirectoryReader_readEntries_future {
  pub fn from(reader: web_sys::FileSystemDirectoryReader) -> FileSystemDirectoryReader_readEntries_future {
    ...
    FileSystemDirectoryReader_readEntries_future { inner: state }
  }
}

impl Future for FileSystemDirectoryReader_readEntries_future {
